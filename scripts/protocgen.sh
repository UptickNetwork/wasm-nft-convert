...
echo "Generating /cw721 proto code"
proto_dirs=$(find ./uptick/cw721 -path -prune -o -name '*.proto' -print0 | xargs -0 -n1 dirname | sort | uniq)
...
cp -r github.com/UptickNetwork/wasm-nft-convert/types/* ./types
rm -rf github.com
